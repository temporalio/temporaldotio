    ...
    <code>
      ...
      <span style="display:block">
        <span style="color: #676E95; font-style: italic">
          // define interactionSignal handler in your favorite framework
        </span>
      </span>
      <span style="display:block">
        <span style="color: #89DDFF; font-style: italic">export</span>
      ...
      <span style="display:block">
        ...
        <span style="color: #F07178"> </span>
        <span style="color: #A6ACCD">userInteracted</span>
        <span style="color: #F07178"> </span>
        <span style="color: #89DDFF">=</span>
        <span style="color: #F07178"> </span>
        <span style="color: #89DDFF; font-style: italic">await</span>
        <span style="color: #F07178"> </span>
        <span style="color: #FFCB6B">Promise</span>
        <span style="color: #89DDFF">.</span>
        <span style="color: #82AAFF">race</span>
        <span style="color: #F07178">([</span>
      </span>
      <span style="display:block">
        <span style="color: #F07178"> </span>
      ...
      <span style="display:block">
        <span style="color: #F07178"> </span>
        <span style="color: #89DDFF; font-style: italic">if</span>
        <span style="color: #F07178"> (</span>
        <span style="color: #89DDFF">!</span>
        <span style="color: #A6ACCD">userInteracted</span>
        <span style="color: #F07178">) </span>
      ...
      <span style="display:block">
        ...
        <span style="color: #89DDFF">;</span>
        <span style="color: #F07178"> </span>
        <span style="color: #676E95; font-style: italic">// timeouts + retries!</span>
      </span>
      <span style="display:block">
        <span style="color: #F07178"> </span>
        <span style="color: #89DDFF">{'}'}</span>
